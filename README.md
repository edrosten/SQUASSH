...
### Generating some of the figures in the paper
...
Likewise, the data can be analyzed and figure 3 generated by running 
`figure_3_plot_nupc.py`. This will output the follwing files:
```
tmp/fig3_spacing_variance_vs_eccentricity.svg
tmp/fig3_bates_angular.svg
tmp/fig3_res32_spacing_v_eccentricity.svg
tmp/fig3_resi_angular.svg
tmp/fig3_resi_pca.svg
``` 
